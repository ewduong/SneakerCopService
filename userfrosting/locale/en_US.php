...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_FIRST_CHAR_LIMIT" => "Your first name must be between {{min}} and {{max}} characters in length.",
	"ACCOUNT_LAST_CHAR_LIMIT" => "Your last name must be between {{min}} and {{max}} characters in length.",
	"ACCOUNT_STREET_CHAR_LIMIT" => "Your street address must be between {{min}} and {{max}} characters in length.",
	"ACCOUNT_CITY_CHAR_LIMIT" => "Your city name must be between {{min}} and {{max}} characters in length.",
	"ACCOUNT_STATE_CHAR_LIMIT" => "Your state name must be between {{min}} and {{max}} characters in length.",
	"ACCOUNT_ZIP_CHAR_LIMIT" => "Your zip code must be {{min}} characters in length.",
	"ACCOUNT_COUNTRY_CHAR_LIMIT" => "Your display name must be between {{min}} and {{max}} characters in length.",
	"ACCOUNT_PHONE_CHAR_LIMIT" => "Your display name must be between {{min}} and {{max}} characters in length.",
	...
	"ACCOUNT_CARDT_CHAR_LIMIT" => "Card type must be between {{min}} and {{max}} characters in length.",
	"ACCOUNT_CARDN_CHAR_LIMIT" => "Card number must be {{max}} digits",
	"ACCOUNT_EXPD_CHAR_LIMIT" => "Expiration date must be between {{max}} characters in length, including the /.",
	"ACCOUNT_CVV_CHAR_LIMIT" => "CVV must be between {{max}} digits in length.",
