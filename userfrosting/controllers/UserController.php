...
class UserController extends \UserFrosting\BaseController {
    ...
    public function pageUser($user_id){
        ...
        $fields = ['display_name', 'email', 'title', 'locale', 'groups', 'primary_group_id', 'first_name', 
					'last_name', 'street_address', 'city', 'state', 'zip_code', 'country', 'phone_number', 'card_type', 'card_number', 'exp_date', 'cvv'];
        $show_fields = [];
        $disabled_fields = [];
        $hidden_fields = [];
